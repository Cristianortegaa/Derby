...
public record ConflictError(string Message) : DerbyError(Message); 

public record UnauthorizedError(string Message) : DerbyError(Message);
public record ForbiddenError(string Message) : DerbyError(Message);
public record InternalServerError(string Message) : DerbyError(Message);

public record DivisionInvalidaError(string Message) : DerbyError(Message);
